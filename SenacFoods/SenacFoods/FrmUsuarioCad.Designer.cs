namespace SenacFoods
{
    partial class FrmUsuarioCad
    {
        ...
        private void InitializeComponent()
        {
            ...
            label6 = new Label();
            comboBoxPerfilUsuario = new ComboBox();
            txtValidaSenha = new TextBox();
            label5 = new Label();
            label4 = new Label();
            ...
            groupBox1.Controls.Add(comboBoxPerfilUsuario);
            groupBox1.Controls.Add(txtValidaSenha);
            groupBox1.Controls.Add(label5);
            groupBox1.Controls.Add(label4);
            groupBox1.Controls.Add(txtEmail);
            groupBox1.Controls.Add(btnCancelarUsuario);
            groupBox1.Controls.Add(btnSalvarUsuario);
        ...
        private TextBox txtValidaSenha;
        private Label label5;
        private TextBox txtTextoCardapio;
        private Panel panel1;
        private Button btnVoltar;
        private ComboBox comboBoxPerfilUsuario;
